        ...
        try:
          ...
          for P in self.__AllowedPatterns:
            ...
            if P.MatchesPattern(PatternString, CurrentSymbol):
              ########## Changes start here ##########
              for C in PatternList: # Checks every cell in the pattern
                if (C.GetSymbol()) != "@" and not C.CheckSymbolAllowed(CurrentSymbol): # Checks if the cell is blocked by the @ and if the symbol is allowed to be used
                  print("You cannot get the same 10 points using previously used cells.")
                  return 0
              ########## Changes end here ##########
